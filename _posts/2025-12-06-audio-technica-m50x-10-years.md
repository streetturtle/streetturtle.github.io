...
Back around 2016, [dbrand](https://dbrand.com/) was selling custom skins specifically designed for the Audio Technica m50x. I picked up a set and applied them to give my headphones a unique look and add some extra protection to the plastic surfaces.

**The result:**
Nearly 9 years later, those dbrand skins are still on my headphones! They've held up remarkably well, with minimal peeling or wear.
...
[![Replacement cable with built-in microphone]({{ site.url }}/images/2025/m50x-replacement-cable.jpg){:.center-image}]({{ site.url }}/images/2025/m50x-replacement-cable.jpg)
...
[![Headband tape]({{ site.url }}/images/2025/m50x-headband.jpg){:.center-image}]({{ site.url }}/images/2025/m50x-headband.jpg)
...
**How to fix it:**
1. Wrap two zip ties around the hinge mechanism, one on each side
2. On the outside of the headband, right above the engraved model name, wrap a zip tie around these two zip ties from the previous step. The tie head will serve as a stop for the ear cup.
3. Add as many zip ties as needed to prevent the ear cup from over-extending. In my case I had 2 for a couple of weeks, then added a third one.
...
{% include image-gallery.html folder="/images/2025/m50x-hinge" %}
...
But then I found [this video](https://www.youtube.com/watch?v=6Vy1GyWK3qw) which explains that the issue might be a broken speaker. To diagnose it, you should measure the resistance using a multimeter. This was exactly my case! 

**How to fix it:**
1. Use a multimeter to test the speaker resistance (working speaker should show 38 ohms)
2. Contact Audio Technica support to order a replacement speaker (~$15-20 USD including delivery)
3. Solder the new speaker in place (not difficult if you have basic soldering skills)

The repair brought my headphones back to life and saved me from having to buy a new pair. 

{% include image-gallery.html folder="/images/2025/m50x-speaker" %}
